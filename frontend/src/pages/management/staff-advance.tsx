                          ...
                          <TableCell className="px-2 sm:px-3 lg:px-4 py-2 lg:py-3 text-center">
                            <div className="flex justify-center">
                              <Avatar className="h-10 w-10">
                                <AvatarImage 
                                  src={staffMember.photo ? `${import.meta.env.VITE_API_URL?.replace(/\/api$/, '')}${staffMember.photo}` : undefined} 
                                />
                ...
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    <Avatar className="h-12 w-12">
                      <AvatarImage 
                        src={selectedStaff.photo ? `${import.meta.env.VITE_API_URL?.replace(/\/api$/, '')}${selectedStaff.photo}` : undefined} 
                      />
                ...
                <div className="flex items-center gap-2 sm:gap-3 md:gap-4 mt-2 sm:mt-4">
                  <div className="relative flex-shrink-0">
                    <div className="w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 rounded-full object-cover border-2 sm:border-4 border-white shadow-lg overflow-hidden bg-gradient-to-r from-blue-500 to-purple-600">
                      {selectedStaff.photo ? (
                        <img
                          src={`${import.meta.env.VITE_API_URL?.replace(/\/api$/, '')}${selectedStaff.photo}`}
